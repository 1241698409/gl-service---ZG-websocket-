...
public abstract class AbstractWebSocketService1 {
                ...
                try {
                    ...
                    for (Object bean : copyOnWriteArraySet) {
                       ...
                       /* String name = "sy";
                        ...
                        // 获取当前连接session字段
                        Field sessionField = AbstractWebSocketService1.class.getDeclaredField("session");
                        Session session = (Session) sessionField.get(bean);
                        // 获取当前连接param字段
                        Field paramField = AbstractWebSocketService1.class.getDeclaredField("param");
                        String param = (String) paramField.get(bean);
                        Field Field = AbstractWebSocketService1.class.getDeclaredField("RUN_FLAG");
