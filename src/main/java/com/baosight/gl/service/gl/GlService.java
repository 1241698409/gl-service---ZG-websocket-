...
public interface GlService {
	 ...
	 * 处理逻辑接口
	 */
	HashMap<Double, List<HashMap>> dealOtherAnglesLine(HashMap paramsMap);

	HashMap<Double, List<HashMap>> dealResidualThickness(HashMap paramsMap);

	HashMap<Object, List<HashMap>> dealResidualThicknessHis(HashMap paramsMap);

	HashMap<Double, List<HashMap>> dealMdWrPointValue();
}